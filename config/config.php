...
//
//define("DB_HOST", "sql211.ihostfull.com");
//define("DB_USER", "uoolo_27549831");
//define("DB_PASSWORD", "2.LwgJTynwDVsGG");
//define("DB_NAME", "Nasa_Hacker");
//
//define('BASE_PATH','http://185.27.134.10/db_structure.php?db=uoolo_27549831_Nasa_Hacker');
//---------------------------------------------------------------------------------
